...
whiptail --title "Wireless OpenAuto RPi" --msgbox "Installing dependences" 8 78
sudo apt-get update
...
whiptail --title "Wireless OpenAuto RPi" --msgbox "Cloning and building Android Auto SDK" 8 78
...
whiptail --title "Wireless OpenAuto RPi" --msgbox "Building ilclient firmware" 8 78
...
whiptail --title "Wireless OpenAuto RPi" --msgbox "Cloning and building OpenAuto" 8 78
git clone -b feature/wireless https://github.com/f1xpl/openauto.git
...
# Starting OpenAuto
whiptail --title "Wireless OpenAuto RPi" --msgbox "Strating OpenAuto" 8 78
